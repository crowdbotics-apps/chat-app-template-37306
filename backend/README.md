...
## Project Structure
    ...
    ├── messaging_and_chat__37306  # Django project configurations
...
1. Clone this repo and `cd messaging_and_chat__37306`
...
2. Clone this repo and `cd messaging_and_chat__37306`
